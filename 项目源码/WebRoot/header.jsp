...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">云笔记本网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
               ...
               <!-- 
                ...
                <li><a href="<%=basePath %>NoteType/frontlist">笔记类型</a></li>
                <li><a href="<%=basePath %>Note/frontlist">笔记资源</a></li>
                <li><a href="<%=basePath %>Collect/frontlist">笔记收藏</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Note/note_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;上传云笔记</a></li>
                        <li><a href="<%=basePath %>Note/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我上传的云笔记</a></li>
                        <li><a href="<%=basePath %>Collect/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我收藏的笔记</a></li>
                        <li><a href="<%=basePath %>Note/userFrontlist2"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的笔记回收站</a></li>
