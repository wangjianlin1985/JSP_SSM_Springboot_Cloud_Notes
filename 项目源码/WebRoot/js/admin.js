		       ...
		       text: "笔记类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "NoteType/noteType_add.jsp"
			    	   	},
			    		{
			    	   		text: "笔记类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "NoteType/noteType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "笔记管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Note/note_add.jsp"
			    	   	},
			    		{
			    	   		text: "笔记管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Note/note_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "笔记收藏管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Collect/collect_add.jsp"
			    	   	},
			    		{
			    	   		text: "笔记收藏管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Collect/collect_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
